...
const portfolioCards = [
    {
        ...
        portfolioImg: "../src/assets/pages/home/portfolio/site-1.png"
    },
    {
        portfolioName: "Veronisa Tour (Pvt)Ltd",
        portfolioUrl: "Veronisatours.lk",
        portfolioImg: "../src/assets/pages/home/portfolio/site-2.png"
    },
    {
        portfolioName: "Veronisa Tour (Pvt)Ltd",
        portfolioUrl: "Veronisatours.lk",
        portfolioImg: "../src/assets/pages/home/portfolio/site-3.png"
    },
    {
        portfolioName: "Veronisa Tour (Pvt)Ltd",
        portfolioUrl: "Veronisatours.lk",
        portfolioImg: "../src/assets/pages/home/portfolio/site-4.png"
    },
    {
        portfolioName: "Veronisa Tour (Pvt)Ltd",
        portfolioUrl: "Veronisatours.lk",
        portfolioImg: "../src/assets/pages/home/portfolio/site-5.png"
    },
];
...
function HomeOurPortfolio() {
    return (
        <section className="home-our-portfolio-section relative w-full max-w-(--max-width) mx-auto px-3 md:px-6 lg:px-4 py-8 md:py-16 lg:py-24">
            ...
            <div className="portfolio-slider flex flex-wrap justify-center mt-4 md:mt-5 lg:mt-6">
                {/* Swiper Slider */}
                <Swiper
                    modules={[Navigation]}
                    spaceBetween={16}
            ...
            <div className="bottom-portfolio flex flex-row justify-between items-center gap-3">
                ...
                <div className="see-more bottom-link flex justify-center">
                    <Link to={'/'}><Button variant="link" className="font-inter-semibold transition-colors hover:text-orange-500">View More <img src="../src/assets/icons/right-white-arrow.png" alt="Arrow" /></Button></Link>
                </div>
            </div>
        </section>
    )
