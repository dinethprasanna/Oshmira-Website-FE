        ...
        <section className="call-to-action-section relative w-full max-w-(--max-width) mx-auto px-3 md:px-6 lg:px-4 py-8 md:py-16 lg:py-24" >
            <div className="cta-gradient-bg rounded-md grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 relative overflow-hidden" data-aos="zoom-in">
                ...
                <div className="cta-img col-span-1 absolute md:relative left-0 right-0 top-0 bottom-0 z-2">
                    ...
                    <img src="/global/cta-girl-on-phone.png" alt="Girl on phone" className="max-w-[420px] h-full w-auto md:max-w-full md:w-auto md:h-full block z-3 relative ml-auto" />
                </div>
                <img src="/global/cta-band.png" alt="Band" className="abslt-band absolute z-0 w-[504px] md:w-[624px] bottom-0 right-0 top-unset" />
            </div>
        </section>
    )
}
