const TestimonialCard = ({ clientName, designation, clientReview, clientImg }) => {
    return (
        <div className="bg-(--bg-second-col) rounded-3xl p-6 lg:px-8 lg:py-16 min-h-[240px] max-w-[300px] md:max-w-[382px] lg:h-[324px] text-center w-full h-full block shine-card-overlay shadow-[-1px_1px_2px_rgba(255,255,255,0.4)_inset]">
