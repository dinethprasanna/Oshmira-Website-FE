    ...
    return (
        <>
            <main className="mx-auto w-full min-h-[80vh]">
                <BreadcrumbHeroSection title={"Our"} gradientTitle={"Solution"} breadcrumb={'Home / Solutions / POS Product'} />
                ...
                <section className="ranto-pos-overview-section relative w-full max-w-(--max-width) mx-auto px-3 md:px-6 lg:px-4 py-8 md:py-16 lg:py-24">
                    <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-5 gap-4 md:gap-9 lg:gap-12 py-8 md:py-9 lg:py-12 px-8 md:px-9 lg:px-12 rounded-md bg-(--bg-second-col) shadow-[-1px_1px_2px_rgba(255,255,255,0.4)_inset]" data-aos="zoom-in-up">
                        <div className="ranto-pos-info col-span-1 md:col-span-2 flex flex-col justify-center" data-aos="fade-right">
                            <h2 className="text-white text-center md:text-left font-inter-semibold text-2xl md:text-3xl lg:text-4xl mb-4 lg:mb-5"><span className='gradient-text-anime'>Point of Sales</span> <br /> Software For Growing Business</h2>
                            <p className="font-inter-light text-white text-center md:text-left text-base md:text-lg max-w-[496px] mb-6 mx-auto md:mx-0">innovative and intuitive  solutions for modern retail business </p>
                        </div>
                        <div className="ranto-pos-banner col-span-1 md:col-span-2 lg:col-span-3 flex flex-col justify-center" data-aos="fade-left">
                            <img src="/global/ranto-pos-banner.png" alt="Ranto POS" className="max-w-[400px] mx-auto lg:max-w-full w-full h-auto block" />
                        </div>
                        ...
                        <div className="md:border-t-1 md:border-slate-400 col-span-1 md:col-span-4 lg:col-span-5 grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-0 pb-2 pt-8 md:py-9 lg:py-12 px-8 md:px-9 lg:px-12 bg-(--bg-second-col)">
                            <div className="info-card text-center flex flex-col justify-center px-0 py-4 md:p-8 border-b-2 border-r-0 md:border-r-2 md:border-b-0 border-slate-400 ">
                                <h3 className="text-white text-base md:text-lg lg:text-xl font-inter-semibold">Online & Offline Support</h3>
                            </div>
                            <div className="info-card text-center flex flex-col justify-center px-0 py-4  md:p-8 border-b-2 border-r-0 md:border-b-0 md:border-r-2 md:border-slate-400 ">
                                <h3 className="text-white text-base md:text-lg lg:text-xl font-inter-semibold">Works with internet connection and in offline mode</h3>
                            </div>
                            <div className="info-card  text-center flex flex-col justify-center px-0 py-4 md:p-8 ">
                                <h3 className="text-white text-base md:text-lg lg:text-xl font-inter-semibold">Cloud sync when online (for premium plans)</h3>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section className="ranto-pos-features-section relative w-full max-w-(--max-width) mx-auto px-3 md:px-6 lg:px-4 py-6 md:py-8 lg:py-10">
                    <div className="pos-info mb-10 md:mb-12 lg:mb-18">
                        <p className="underline font-inter-medium text-white text-left text-base md:text-lg mb-6 mx-auto md:mx-0">Descriptions</p>
                        <p className="font-inter-light text-white text-left text-base md:text-lg mb-6 mx-auto md:mx-0">
                            <b>Ranto POS</b> is an all-in-one Point of Sale system designed to simplify operations and maximize efficiency for retail and service businesses. Whether you're managing a grocery store, apparel outlet, electronics shop, pharmacy, or restaurant, Ranto POS adapts to your needs. From smart billing and real-time stock management to customer tracking and detailed reporting, Ranto POS helps eliminate the chaos of manual processes - giving you better control, higher profits, and satisfied
                        </p>
                    </div>

                    <div className="pos-info mb-10 md:mb-12 lg:mb-18">
                        <p className="underline font-inter-medium text-white text-left text-base md:text-lg mb-6 mx-auto md:mx-0">Key Features</p>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 ">
                            <div className="key-lists-left">
                                <div className="mb-5 md:mb-8">
                                    <p className="font-inter-light text-white text-left text-base md:text-lg mb-3 mx-auto md:mx-0">Sales Management</p>
                                ...
                                <div className="mb-5 md:mb-8">
                                    <p className="font-inter-light text-white text-left text-base md:text-lg mb-3 mx-auto md:mx-0">Inventory Management</p>
                                    <div className="font-inter-light text-white text-left text-base md:text-lg ">
                                        <ul className="text-white text-left font-inter-light text-sm md:text-base list-disc list-outside pl-5 ">
                                ...
                                <div className="mb-5 md:mb-8">
                                    <p className="font-inter-light text-white text-left text-base md:text-lg mb-3 mx-auto md:mx-0"> Repair Management</p>
                                    <div className="font-inter-light text-white text-left text-base md:text-lg ">
                                        <ul className="text-white text-left font-inter-light text-sm md:text-base list-disc list-outside pl-5 ">
                            ...
                            <div className="key-lists-right">
                                <div className="mb-5 md:mb-8">
                                    <p className="font-inter-light text-white text-left text-base md:text-lg mb-3 mx-auto md:mx-0">Customer Management</p>
                                    <div className="font-inter-light text-white text-left text-base md:text-lg ">
                                        <ul className="text-white text-left font-inter-light text-sm md:text-base list-disc list-outside pl-5 ">
                                ...
                                <div className="mb-5 md:mb-8">
                                    <p className="font-inter-light text-white text-left text-base md:text-lg mb-3 mx-auto md:mx-0">Reporting</p>
                                    <div className="font-inter-light text-white text-left text-base md:text-lg ">
                                        <ul className="text-white text-left font-inter-light text-sm md:text-base list-disc list-outside pl-5 ">
